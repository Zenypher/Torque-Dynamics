          ...
          <div className="flex flex-col bg-background p-6 gap-y-6">
            <div className="bg-background flex items-start justify-between">
              <div className="flex flex-col gap-y-2">
                <div className="w-60 h-8 bg-ui-bg-subtle animate-pulse" />
                <div className="w-48 h-6 bg-ui-bg-subtle animate-pulse" />
              </div>
              <div>
                <div className="w-14 h-8 bg-ui-bg-subtle animate-pulse" />
              </div>
            </div>
            <div>
              <div className="pb-3 flex items-center">
                <div className="w-20 h-12 bg-ui-bg-subtle animate-pulse" />
              </div>
              <Table>
                <Table.Header className="border-t-0">
                  <Table.Row>
                    ...
                    <Table.HeaderCell>
                      <div className="w-16 h-6 bg-ui-bg-subtle animate-pulse" />
                    </Table.HeaderCell>
                    <Table.HeaderCell>
